...
class AppConfig {
  ...
  static Future<bool> isDefaultServerReachable() =>
      _tcpPing(defaultBaseUrl);

  /// Fast TCP ping to the currently configured server (3 s timeout).
  static Future<bool> isCurrentServerReachable() =>
      _tcpPing(_baseUrl);
  ...
  static String get xtreamApiFallbackBase =>
      '$_baseUrl/api/player_api.php?username=$_username&password=$_password';

  // Standard M3U path
  static String get playlistUrl =>
      '$_baseUrl/get.php?username=$_username&password=$_password'
      '&type=m3u_plus&output=m3u8';

  // Fallback M3U path used by some servers (/api/get.php)
  static String get playlistFallbackUrl =>
      '$_baseUrl/api/get.php?username=$_username&password=$_password'
      '&type=m3u_plus&output=m3u8';

  static String liveStreamUrl(int streamId, {String ext = 'ts'}) =>
      '$_baseUrl/live/$_username/$_password/$streamId.$ext';
