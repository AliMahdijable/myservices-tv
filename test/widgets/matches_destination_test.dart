...
/// The matches destination sits alongside home/search/settings on both the
/// phone bottom bar and the wide nav rail. These pin the tap contract and
/// guard the bottom bar against a fourth item overflowing a small phone.
void main() {
  ...
  group('phone bottom bar', () {
    testWidgets('shows the matches destination and invokes its callback', (
      tester,
    ) async {
      var taps = 0;
